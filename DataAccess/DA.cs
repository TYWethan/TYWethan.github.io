...
namespace DataAccess
{
    public static class DA
    {
        ...
        static DA()
        {
            ...
            myconn.ConnectionString = ConfigurationManager.ConnectionStrings["GameAccessoriesShopConn"].ConnectionString;
            scd = new SqlCommand();
        ...
        #region 执行查询命令，返回一个DataTable，有无参数均可
        /// <summary>
